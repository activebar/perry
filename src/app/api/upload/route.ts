...
export async function POST(req: NextRequest) {
  try {
    ...
    return NextResponse.json({ ok: true, id: (inserted as any)?.id || null, path, publicUrl, thumbUrl, kind: dbKind, editable_until: (inserted as any)?.editable_until || editable_until, is_approved, autoApproveUntil })
  } catch (e: any) {
